...
public class CampingDetailActivity extends AppCompatActivity {
    ...
    class DetailThread extends Thread {
        ...
        public void run(){
            try {
                ...
                URL url = new URL("http://api.visitkorea.or.kr/openapi/service/rest/KorService/detailCommon?ServiceKey=bcgZx%2BNS6vjxiskUoogaZOW7Q59DvyU12YsbSBTkj4mhWb8gXSKpehLFaJaB6%2BzsS%2FazsuuXyfJuj5rPph62UA%3D%3D&contentTypeId=28&contentId="+contentid+"&MobileOS=ETC&MobileApp=TourAPI3.0_Guide&defaultYN=Y&firstImageYN=Y&areacodeYN=Y&catcodeYN=Y&addrinfoYN=Y&mapinfoYN=Y&overviewYN=Y&transGuideYN=Y&_type=json");
    ...
    Handler DetailHandler = new Handler(Looper.getMainLooper()){
        public void handleMessage(Message message) {
            ...
            try {
                ...
                mapView = new MapView(CampingDetailActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CampingDetailActivity.DetailThread().start();

        new CampingDetailActivity.ImageThread1().start();
