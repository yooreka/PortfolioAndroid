...
public class MuseumActivity extends AppCompatActivity {
    ...
    class ThreadEx extends Thread{
        ...
        public void run(){
            try{
                URL url = new URL("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?ServiceKey=bcgZx%2BNS6vjxiskUoogaZOW7Q59DvyU12YsbSBTkj4mhWb8gXSKpehLFaJaB6%2BzsS%2FazsuuXyfJuj5rPph62UA%3D%3D&contentTypeId=14&areaCode=&sigunguCode=&cat1=A02&cat2=A0206&cat3=A02060100&listYN=Y&MobileOS=ETC&MobileApp=TourAPI3.0_Guide&arrange=A&numOfRows=12&pageNo="+pageNo+"&_type=json");
        ...
        listView.setOnItemClickListener(new ListView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                try {
                    ...
                    Intent intent = new Intent(MuseumActivity.this, MuseumDetailActivity.class);
        ...
        listView.setOnScrollListener(new ListView.OnScrollListener(){
            ...
            public void onScrollStateChanged(AbsListView absListView, int scrollstate) {
                if(scrollstate==ListView.OnScrollListener.SCROLL_STATE_IDLE && lastItemVisibleFlag == true) {
                    pageNo = pageNo + 1;
                    new ThreadEx().start();
                }else if(data.size()==480){
                    Toast.makeText(MuseumActivity.this, "더 이상 데이터가 없습니다.", Toast.LENGTH_LONG).show();
                }
            }
