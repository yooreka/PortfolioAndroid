...
public class TemaParkActivity extends AppCompatActivity {
    ListView listView;
        ...
        listView.setOnItemClickListener(new ListView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                try {
                    ...
                    Intent intent = new Intent(TemaParkActivity.this, TemaParkDetailActivity.class);
        ...
        listView.setOnScrollListener(new ListView.OnScrollListener(){
            ...
            public void onScrollStateChanged(AbsListView absListView, int scrollstate) {
                if(scrollstate==ListView.OnScrollListener.SCROLL_STATE_IDLE && lastItemVisibleFlag == true) {
                    pageNo = pageNo + 1;
                    new ThreadEx().start();
                }else if(data.size()>156){
                    Toast.makeText(TemaParkActivity.this, "더 이상 데이터가 없습니다.", Toast.LENGTH_LONG).show();
                }
            }
