...
public class TemaParkDetailActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message message) {
          ...
          //  Log.e("result data :", result.toString());
            ...
            try {
                ...
                mapView = new MapView(TemaParkDetailActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new TemaParkDetailActivity.DetailThread().start();

        new TemaParkDetailActivity.ImageThread1().start();
