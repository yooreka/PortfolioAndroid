    ...
    class ThreadEx extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                //파라미터 만들기
                String lineEnd = "\r\n";
                String[] data = {emailinput.getText().toString().trim(),
                ...
                for (int i = 0; i < data.length; i = i + 1) {
                    ...
                    postDataBuilder.append("Content-Disposition: "
                            + "form-data; name=\"" + dataNames[i] + "\"" + lineEnd + lineEnd + data[i] + lineEnd);
                }
                //파일파라미터 만들기
                ...
                if (fileName != null) {
                    postDataBuilder.append(delimiter);
                    postDataBuilder.append("Content-Disposition: "
                            + "form-data; name=\"" + "profile" + "\";filename=\"" + fileName + "\"" + lineEnd);
...
//                            + "form-data; name=\"" + "profile" + "\";filename=\"" + fileName + "\"" + lineEnd);
        ...
        private boolean validationCheck() {
            ...
            if (msg == null) {
                ...
                Toast.makeText(
                        UserActivity.this, msg, Toast.LENGTH_LONG)
                        .show();
            }
